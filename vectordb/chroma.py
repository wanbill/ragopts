    ...
    def __init__(
        ...
        self._collection = self._client.get_or_create_collection(
            ...
            embedding_function=self._embedding_function.embed_documents if \
                hasattr(self._embedding_function, "embed_documents") else \
        ...
        **kwargs: Any,
        ...
        if self._embedding_function is not None:
            if hasattr(self._embedding_function, "embed_documents"):
                ...
                embeddings = self._embedding_function(list(texts))
    ...
    def similarity_search_with_score(
        ...
        **kwargs: Any,
        ...
        if self._embedding_function is None:
            ...
            query_embedding = self._embedding_function.embed_query(query) if \
                hasattr(self._embedding_function, "embed_query") else \
                self._embedding_function(query)
